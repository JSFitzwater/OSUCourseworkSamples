...
import { Accordion, Button, Container, Icon, Grid, Menu } from 'semantic-ui-react'
    ...
    return (
      <Grid padded='horizontally' columns={1}>
        <Grid.Column color='teal' className='menu'>
          <Menu color='teal' size='huge' borderless inverted secondary className='main'>
            <Grid container columns={1}>
              ...
              <Grid.Row only='tablet mobile'>
                ...
                <Grid.Column>
                  <Accordion fluid id='accordion-menu' style={{ 'display': 'none' }}>
