            ...
            {Object.values(stockData).map((data) =>
              <Table.Row key={data.symbol}>
                ...
                <Table.Cell textAlign='right' key={`${data.symbol}-${data.change}-change`}>
                  <font color={data.change < 0 ? 'red' : (data.change > 0 ? 'green' : 'grey')}>
                ...
                <Table.Cell textAlign='right' key={`${data.symbol}-${data.percent_change}-percent-change`}>
                  <font color={data.percent_change < 0 ? 'red' : (data.percent_change > 0 ? 'green' : 'grey')}>
                    {data.percent_change.toFixed(2)}%
                  </font>
                </Table.Cell>

                {/* Volume */}
                <Table.Cell textAlign='right' key={`${data.symbol}-${data.volume}-volume-`}>
